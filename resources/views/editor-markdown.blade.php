...
<head>
    ...
    <!--markdown-->
    <link href="assets/vendor/simplemde-markdown/simplemde.min.css" rel="stylesheet">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                <a  href="javascript:;" class="active">Editos</a>
                                <ul class="sub">
                                    <li><a  href="editor-summernote.html">Summernote</a></li>
                                    <li class="active"><a  href="editor-markdown.html">Markdown</a></li>
                                </ul>
                            </li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Editor Markdown
                    <small>editor markdown page</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Editor Markdown</li>
                </ol>
            </div>
            <!--page title end-->
...
![Yes](https://i.imgur.com/sZlktY7.png)</textarea>
    ...
    <!--markdown-->
    <script src="assets/vendor/simplemde-markdown/simplemde.min.js"></script>
    <script>
        new SimpleMDE({
