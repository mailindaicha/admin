    ...
    <div class="app-body">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="form-dropzone.html"> Dropzone</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Dropzone
                    <small>somw dropzone examples</small>
                </h4>
                ...
                <div class="row">
                    <div class=" col-md-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <form class="dropzone mb-4" id="singleFileUpload" action="/upload.php">
