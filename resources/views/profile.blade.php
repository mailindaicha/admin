    ...
    <div class="app-body">
        ...
        <main class="main-content">
                    ...
                    <div class="row mb-4 pt-5 pb-3 d-flex align-items-end">
                        <div class="col-md-6">
                            <div class="media mb-4">
                                <img class="align-self-center mr-3 rounded-circle" src="assets/img/user3.png" alt="profile user" width="45">
                                <div class="media-body mt-1 profile-text-shadow">
                                    <strong class="f18">JONATHAN SMITH</strong>
                                    <p class="mb-0 f12">Web Designer</p>
                                </div>
                            </div>
                            <button type="button" class="btn btn-sm btn-primary"> <i class="icon-user pr-1"></i> Add Friend</button>
                            <button type="button" class="btn btn-sm btn-info"><i class=" icon-user-following pr-1"></i>Following</button>
                            <button type="button" class="btn btn-sm btn-success"><i class="  icon-cursor pr-1"></i>Message</button>
                        </div>
                        <div class="col-md-6">
                            <div class="text-lg-right profile-text-shadow">
                                <div class="d-inline-block px-3 text-center text-light">
                                    <strong class="f24 d-block">1563</strong>
                                    <small>Friends</small>
                                </div>
                                <div class="d-inline-block px-3 text-center text-light">
                                    <strong class="f24 d-block">12332</strong>
                                    <small>Followers</small>
                                </div>
                                <div class="d-inline-block px-3 text-center text-light">
                                    <strong class="f24 d-block">5643</strong>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class=" col-md-8">
                        <div class="card profile-status mb-4">
                            <form>
                                <textarea class="form-control" rows="2" placeholder="Whats in your mind today?" ></textarea>
                            </form>
                            <footer class="card-footer">
                                <button class="btn btn-success float-right">Post</button>
                        ...
                        <ul class="profile-timeline">
                            <li>
                                <div class="profile-timeline-thumb">
                                    <img src="assets/img/user1.png" alt="">
                                </div>
                                <div class="profile-timeline-thumb-desk">
                                    <span>13 mins ago near NY, USA</span>
                                    <a href="#">john doe </a>
                                    <div class=" mt-3">
                            ...
                            <li>
                                ...
                                <div class="profile-timeline-thumb-desk">
                                    <span>1 days ago, Canada</span>
                                    <a href="#">Tnisha</a>
                                    <div class="mt-3">Ipsume ement <a href="#" class="text-success"> link here</a> Etharums ser quidem dolores nemis omnis fugats vitaes nemo minim.
                            ...
                            <li>
                                ...
                                <div class="profile-timeline-thumb-desk">
                                    ...
                                    <a href="#">jane doe</a>
                                    <p>Uploaded product image gallary</p>
                                    <div class="profile-gallery mt-3">
                                        <a href="#"><img src="assets/img/product_3.jpg" alt=""></a>
                                        <a href="#"><img src="assets/img/product_6.jpg" alt=""></a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="profile-timeline-thumb-desk">
                                    <span>4 days ago, UK</span>
                                    <a href="#">Tassi Sazzu </a> Send you a pdf file
                                    <div class="mt-3">
                                        <a href="#" class="text-primary"><i class="fa fa-file-pdf-o"> </i> project-overview.pdf</a>
                                    </div>
                                </div>
                                ...
                                <ul class="profile-timeline">
                                    ...
                                    <li>
                                        ...
                                        <div class="profile-timeline-thumb-desk">
                                            <span>10 days ago near, KSA</span>
                                            <a href="#">Mr Noreman </a> Mission accomplished
                                            <div class=" mt-3">
                                                vitaes nemo minima rerums unsers sadips amets. Lid est laborum dolo rumes fugats untras.
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="profile-timeline-thumb-desk">
                                            <span>6 days ago near Melborn, Australia</span>
                                            <a href="#">Kemi Rose</a>
                                            <div class="mt-3">
                                                dolores nemis omnis fugats vitaes nemo minima rerum facilis dolores
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <li>
                                ...
                                <div class="profile-timeline-thumb-desk">
                                    <span>10 days ago, USA</span>
                                    <a href="#">jonathan Smith </a>
                                    <div class="mt-3">Setting up a video conference</div>
                                </div>
                            </li>
                            <li>
                                <div class="profile-timeline-thumb">
                                ...
                                <div class="profile-timeline-thumb-desk">
                                    ...
                                    <a href="#">Mikhail Morkel</a>
                                    <div class="mt-3">
                                        Fugats vitaes nemo minima rerums unsers sadips amets. Minima rerums unsers sadips amets.
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class=" col-md-4">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem dolores nemis omnis fugats vitaes nemo minima rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets. Lid est laborum dolo rumes fugats untras.</p>
                                <button type="button" class="btn btn-sm btn-info">Know More</button>
                            </div>
                        </div>
                        <div class="card card-shadow mb-4">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    <li class="mb-3 pb-3 border-bottom-1">
                                        <div class="media">
                                            <a href="#"><img class="align-self-center mr-3 rounded-circle" src="assets/img/user.png" alt="profile user" width="35"></a>
                                            <div class="media-body mt-1">
                                                <a href="#" class="default-color"><strong class="f12">John Doe</strong></a>
                                            </div>
                                            <div class="float-right">
                                                <button type="button" class="btn btn-sm btn-outline-secondary"> <i class="icon-user pr-1"></i>Friend</button>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="mb-3 pb-3 border-bottom-1">
                                        <div class="media">
                                            <a href="#"><img class="align-self-center mr-3 rounded-circle" src="assets/img/user1.png" alt="profile user" width="35"></a>
                                            <div class="media-body mt-1">
                                                <a href="#" class="default-color"><strong class="f12">Jonathan Smith</strong></a>
                                            </div>
                                            <div class="float-right">
                                                <button type="button" class="btn btn-sm btn-outline-secondary"> <i class="icon-user pr-1"></i>Friend</button>
                                            </div>
                                    ...
                                    <li class="mb-3 pb-3 border-bottom-1">
                                        <div class="media">
                                            <a href="#"><img class="align-self-center mr-3 rounded-circle" src="assets/img/user2.png" alt="profile user" width="35"></a>
                                            <div class="media-body mt-1">
                                                <a href="#" class="default-color"><strong class="f12">Tnisha Sabrin</strong></a>
                                            </div>
                                            <div class="float-right">
                                                <button type="button" class="btn btn-sm btn-outline-secondary"> <i class="icon-user pr-1"></i>Friend</button>
                                            </div>
                                    ...
                                    <li>
                                        <div class="media">
                                            <a href="#"><img class="align-self-center mr-3 rounded-circle" src="assets/img/user3.png" alt="profile user" width="35"></a>
                                            <div class="media-body mt-1">
                                                <a href="#" class="default-color"><strong class="f12">Lisa Bela</strong></a>
                                            </div>
                                            <div class="float-right">
                                                <button type="button" class="btn btn-sm btn-outline-secondary"> <i class="icon-user pr-1"></i>Friend</button>
                                            </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="notification-list">
                                    ...
                                    <a href="#" class="btn btn-sm btn-info">View More Notifications</a>
                                </div>
                            </div>
                        </div>
                    </div>
