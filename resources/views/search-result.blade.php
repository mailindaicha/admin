                    ...
                    <div class="col-md-12">
                        <div class="input-group mb-4">
                            ...
                            <span class="input-group-append">
                                <button class="btn btn-primary text-uppercase pl-5 pr-5" type="button">Search</button>
                            </span>
                        ...
                        <div class="card card-shadow mb-4">
                            <div class="card-header bg-secondary text-light border-0">
                                <div class="search-result-Stats">
                                    <h5 class="text-light">Search Result For "2018 Best Admin Template Ever"</h5>
                                    <p class="mb-0">About 104,12365 result ( 0.43 seconds)</p>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled search-results">
                                    <li>
                                        <div class="title">
                                            <h6><a href="#">Diverse is the 2018 Best Admin Template</a></h6>
                                            <a href="#">http://diverse-admin-best.com</a>
                                        </div>
                                    ...
                                    <li>
                                        <div class="title">
                                            <h6><a href="#">Tons of Plugins</a></h6>
                                            <a href="#">http://diverse-plgins-example.com</a>
                                        </div>
                                        <p>Loem ipusm aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                    </li>
                                    <li>
                                        <div class="title">
                                            <h6><a href="#">Bootstrap 4 admin template</a></h6>
                                            <a href="#">http://bootstrap-4.com</a>
                                        </div>
                                    ...
                                    <li>
                                        <div class="title">
                                            <h6><a href="#">The most easy to customize</a></h6>
                                            <a href="#">http://easy-customizable.com</a>
                                        </div>
                                        <p>Lipsum aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                    </li>
                                    <li>
                                        <div class="title">
                                            <h6><a href="#">Huge UI kits for Dashboard</a></h6>
                                            <a href="#">http://kits-ui-exmaple.com</a>
                                        </div>
