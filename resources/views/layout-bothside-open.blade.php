...
<head>
    ...
    <title>Layout Bothtside Open</title>
...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed">
    ...
    <div class="app-body">
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Layout Bothtside Open
                    <small>subtitle goes here</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Layout Bothtside Open</li>
                </ol>
            </div>
            <!--page title end-->
