...
<head>
    ...
    <title>Calendar External Events</title>
...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="calendar-external-events.html">External Events Calendar</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Calendar External Events
                    <small>subtitle goes here</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Calendar External Events</li>
                </ol>
            </div>
            <!--page title end-->
    ...
    <!--calendar init-->
    <script src='assets/vendor/calendar-external-events-init.js'></script>
