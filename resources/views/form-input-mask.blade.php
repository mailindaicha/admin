    ...
    <div class="app-body">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="form-input-mask.html">Input Mask</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Input Mask
                    <small>some input mask example</small>
                </h4>
                            ...
                            <div class="card-body">
                                <form class="picker-form">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_1">
                                            <small class="form-text text-muted">Example : mm/dd/yyyy</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Custom Placeholder </label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_2">
                                            <small class="form-text text-muted">Example : dd/mm/yyyy</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Phone Number</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_3">
                                            <small class="form-text text-muted">Example : + (999) 999-9999</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Currency Format</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_7">
                                            <small class="form-text text-muted">Example : Currency format $ ___.__1.234,56</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">ip address</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_8">
                                            <small class="form-text text-muted">Example : 192.168.123.321</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Expty Placeholder</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_4">
                                            <small class="form-text text-muted">Example : 99-9999999</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Repeating Mask</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_5">
                                            <small class="form-text text-muted">mask "9999999999" (max 10 numeric number)</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Right Align</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_6">
                                            <small class="form-text text-muted">Example : Right Align Mask</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="inputmask_9">
                                            <small class="form-text text-muted">Example : _@_</small>
                                        </div>
                                    </div>
                                </form>
                            </div>
