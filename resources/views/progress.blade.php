    ...
    <div class="app-body">
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Progress
                    <small>different Progress style</small>
                </h4>
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: 20%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress mb-4" style="height: 10px;">
                                    <div class="progress-bar bg-primary progress-bar-striped" role="progressbar" style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="progress mb-4">
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-warning progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%"></div>
                                </div>
                                <div class="progress mb-4">
