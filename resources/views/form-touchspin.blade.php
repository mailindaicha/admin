...
<head>
    ...
    <!--touchspin-->
    <link href="assets/vendor/touchspin/jquery.bootstrap-touchspin.min.css" rel="stylesheet">
...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li class="active"><a  href="form-touchspin.html">Touchpin</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Touchspin
                    <small>some touchspin examples</small>
                </h4>
                            ...
                            <div class="card-body">
                                <form class="picker-form">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Default</label>
                                        <div class="col-sm-4">
                                            <input id="demo" type="text" value="1" name="demo">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">With Postfix</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">With Prefix</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Vertical Custom Icon</label>
                                        <div class="col-sm-4">
                                            <input id="demo_vertical" class="form-control bootstrap-touchspin-vertical-btn" type="text" value="1" name="demo_vertical">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label col-form-label-sm">Vertical Custom Icon </label>
                                        <div class="col-sm-4">
                                            <input id="demo_vertical2" class="form-control bootstrap-touchspin-vertical-btn" type="text" value="1" name="demo_vertical2">
                                        </div>
                                    </div>
    ...
    <script src="assets/vendor/touchspin-init.js"></script>
