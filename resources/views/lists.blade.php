    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="lists.html">Lists</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Lists Page
                    <small>some lists</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="default-color">BS Elements</a></li>
                            ...
                            <div class="card-body">
                                <div class="baseline baseline-border">
                                    <div class="baseline-list">
                                        <div class="baseline-info">
                                            <div class="basline-icon float-left">
                                                <i class="  icon-badge f24 text-muted mr-3"></i>
                                            </div>
                                    ...
                                    <div class="baseline-list baseline-border">
                                        <div class="baseline-info">
                                            <div class="basline-icon float-left">
                                                <i class=" icon-present f24 text-muted mr-3"></i>
                                            </div>
                                    ...
                                    <div class="baseline-list  baseline-border">
                                        <div class="baseline-info">
                                            <div class="basline-icon float-left">
                                                <i class=" icon-globe-alt f24 text-muted mr-3"></i>
                                            </div>
                                    ...
                                    <div class="baseline-list  baseline-border">
                                        <div class="baseline-info">
                                            <div class="basline-icon float-left">
                                                <i class="  icon-social-github f24 text-muted mr-3"></i>
                                            </div>
                                    ...
                                    <div class="baseline-list  baseline-border">
                                        <div class="baseline-info">
                                            <div class="basline-icon float-left">
                                                <i class=" icon-note f24 text-muted mr-3"></i>
                                            </div>
                                ...
                                <div class="row">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
                                                <a href="#" class=" default-color">
                                                    <i class="icon-basket-loaded pr-2"></i> New order
                                                </a>
                                            </li>

                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class="icon-user-follow pr-2"></i> New registered member
                                                </a>
                                            </li>

                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class=" icon-layers pr-2"></i> Server error report
                                                </a>
                                            </li>
                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class=" icon-note pr-2"></i> Database report
                                                </a>
                                            </li>
                                            <li class="mb-2">
                                                <a href="#" class=" default-color">
                                            ...
                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class=" icon-present pr-2"></i> Order confirmation
                                                </a>
                                            </li>
                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                    ...
                                    <div class="col">
                                        <ul class="list-unstyled">
                                            <li class="mb-2">
                                                <a href="#" class=" default-color">
                                                    <i class="icon-basket-loaded text-primary pr-2"></i> New order
                                                </a>
                                            </li>

                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class="icon-user-follow text-success pr-2"></i> New registered member
                                                </a>
                                            </li>

                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class=" icon-layers text-danger pr-2"></i> Server error report
                                                </a>
                                            </li>
                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class=" icon-note text-warning pr-2"></i> Database report
                                                </a>
                                            </li>
                                            <li class="mb-2">
                                                <a href="#" class=" default-color">
                                            ...
                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                                    <i class=" icon-present text-info pr-2"></i> Order confirmation
                                                </a>
                                            </li>
                                            <li class="mb-2">
                                                <a href="#" class="default-color ">
                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
                                        <div class="d-flex w-100 justify-content-between">
                                            <h5 class="mb-1 text-light">List group item heading</h5>
