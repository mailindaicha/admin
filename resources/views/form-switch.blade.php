    ...
    <div class="app-body">
                        ...
                        <ul class="sub">
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="form-switch.html">Switch</a></li>
                                </ul>
                            </li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Switch
                    <small>some example of switch</small>
                </h4>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Unchecked</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Checked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light" id="cb2" type="checkbox" checked/>
                                            <label class="tgl-btn" for="cb2"></label>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Disabled</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light" id="cb3" type="checkbox" disabled/>
                                            <label class="tgl-btn" for="cb3"></label>
                                        </div>
                                    </div>

                                    <p class="fw-600">Colorful Switch</p>

                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Primary Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light tgl-primary" id="cb4" type="checkbox" checked/>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Info Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light tgl-info" id="cb5" type="checkbox" checked/>
                                            <label class="tgl-btn" for="cb5"></label>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Success Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light tgl-success" id="cb6" type="checkbox" checked/>
                                            <label class="tgl-btn" for="cb6"></label>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Danger Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light tgl-danger" id="cb7" type="checkbox" checked/>
                                            <label class="tgl-btn" for="cb7"></label>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Warning Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-light tgl-warning" id="cb8" type="checkbox" checked/>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Unchecked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios" id="os1" type="checkbox"/>
                                            <label class="tgl-btn" for="os1"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Checked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios" id="os2" type="checkbox" checked/>
                                            <label class="tgl-btn" for="os2"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Disabled</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios" id="os3" type="checkbox" disabled/>
                                            <label class="tgl-btn" for="os3"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Primary Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios tgl-primary" id="os4" type="checkbox" checked/>
                                            <label class="tgl-btn" for="os4"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Info Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios tgl-info" id="os5" type="checkbox" checked/>
                                            <label class="tgl-btn" for="os5"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Success Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios tgl-success" id="os6" type="checkbox" checked/>
                                            <label class="tgl-btn" for="os6"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Danger Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios tgl-danger" id="os7" type="checkbox" checked/>
                                            <label class="tgl-btn" for="os7"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Warning Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-ios tgl-warning" id="os8" type="checkbox" checked/>
                                            <label class="tgl-btn" for="os8"></label>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Unchecked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed" id="sk1" type="checkbox"/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk1"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Checked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed" id="sk2" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk2"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Disabled</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed" id="sk3" type="checkbox" disabled/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk3"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Primary Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed tgl-primary" id="sk4" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk4"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Info Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed tgl-info" id="sk5" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk5"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Success Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed tgl-success" id="sk6" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk6"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Danger Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed tgl-danger" id="sk7" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk7"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Warning Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-skewed tgl-warning" id="sk8" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="OFF" data-tg-on="ON" for="sk8"></label>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Unchecked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat" id="fl1" type="checkbox"/>
                                            <label class="tgl-btn" for="fl1"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Checked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat" id="fl2" type="checkbox" checked/>
                                            <label class="tgl-btn" for="fl2"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Disabled</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat" id="fl3" type="checkbox" disabled/>
                                            <label class="tgl-btn" for="fl3"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Primary Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat tgl-flat-primary" id="fl4" type="checkbox" checked/>
                                            <label class="tgl-btn" for="fl4"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Info Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat tgl-flat-info" id="fl5" type="checkbox" checked/>
                                            <label class="tgl-btn" for="fl5"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Success Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat tgl-flat-success" id="fl6" type="checkbox" checked/>
                                            <label class="tgl-btn" for="fl6"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Danger Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat tgl-flat-danger" id="fl7" type="checkbox" checked/>
                                            <label class="tgl-btn" for="fl7"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Warning Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flat tgl-flat-warning" id="fl8" type="checkbox" checked/>
                                            <label class="tgl-btn" for="fl8"></label>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Unchecked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip" id="fp1" type="checkbox"/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp1"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Default Checked</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip" id="fp2" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp2"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Disabled</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip" id="fp3" type="checkbox" disabled/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp3"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Primary Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip tgl-flip-primary" id="fp4" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp4"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Info Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip tgl-flip-info" id="fp5" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp5"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Success Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip tgl-flip-success" id="fp6" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp6"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Danger Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip tgl-flip-danger" id="fp7" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp7"></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-4 col-form-label col-form-label-sm">Warning Color</label>
                                        <div class="col-sm-8">
                                            <input class="tgl tgl-flip tgl-flip-warning" id="fp8" type="checkbox" checked/>
                                            <label class="tgl-btn" data-tg-off="Nope" data-tg-on="Yeah!" for="fp8"></label>
                                        </div>
                                    </div>
                                </form>
                            </div>
