...
<head>
    ...
    <!--Morris Chart -->
    <link rel="stylesheet" href="assets/vendor/morris-chart/morris.css">
...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="morris-chart.html">Morris Charts</a></li>
                        </ul>
                    </li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Morris Charts
                    <small>some morris charts example</small>
                </h4>
    ...
    <script src="assets/vendor/morris-init.js"></script>
