    ...
    <div class="app-body">
            ...
            <nav class="sidebar-menu">
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="active"><a  href="flot-chart.html">Flot Charts</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Flot Charts
                    <small>some flot chart example</small>
                </h4>
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="real-time">
                                    <div id="real-time-container" style="height: 300px">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="combine-chart">
                                    <div id="combine-chart-container" style="height: 300px">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="toggle-chart">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="series-list">
                                                    <label class="checkbox inline">
                                                        <input id="chartType1" checked name="ct" type="radio" value="line" />Line Chart</label>
                                                    <label class="checkbox inline">
                                                        <input id="chartType2" name="ct" type="radio" value="bar" />Bar Chart</label>
                                                </div>
                                            </div>
                                        </form>
                                        <form class="form-horizontal pull-right">
                                            <div class="control-group ">
                                                ...
                                                <div class="series-list">
                                                    ...
                                                    <label class="checkbox inline">
                                                        <input type="checkbox" id="cbdata2" checked>data Two</label>
                                                    <label class="checkbox inline">
                                                        <input type="checkbox" id="cbdata3" checked>data Three</label>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div id="toggle-chart-container" style="height: 300px">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="donut-chart" class="pie-chart">
                                    <div id="donut-chart-container" style="height: 300px">
                                    </div>
                                </div>
                            </div>
                        </div>
