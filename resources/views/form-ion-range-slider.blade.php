...
<head>
    ...
    <!--ion range slider-->
    <link href="assets/vendor/ion.rangeSlider-master/css/ion.rangeSlider.css" rel="stylesheet">
    <link href="assets/vendor/ion.rangeSlider-master/css/ion.rangeSlider.skinFlat.css" rel="stylesheet">
...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                <a  href="javascript:;" class="active">Advanced Form</a>
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="form-ion-range-slider.html"> Ion Range Slider</a></li>
                                </ul>
                            </li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Ion Range Slider
                    <small>some ion range slider examples</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="default-color">Form</a></li>
                    <li class="breadcrumb-item active">Ion Range Slider</li>
                </ol>
            </div>
            <!--page title end-->
                ...
                <div class="row">
                    <div class=" col-md-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <small class="mb-3">Set min value, max value and start point</small>
                                <div class="mb-3"><input type="text" id="range_02" value="" name="range" /></div>
                                <small class="mb-3">Set type to double and specify range, also showing grid and adding prefix "$"</small>
                                <div><input type="text" id="range_03" value="" name="range" /></div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow mb-4">
                            <div class="card-header">
                                <div class="card-title">
                                    Multi Color Ion Slider
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="ion-primary mb-3"><input type="text" id="range_color_1" value="" name="range" /></div>
                                <div class="ion-success mb-3"><input type="text" id="range_color_2" value="" name="range" /></div>
                                <div class="ion-info mb-3"><input type="text" id="range_color_3" value="" name="range" /></div>
                                <div class="ion-warning mb-3"><input type="text" id="range_color_4" value="" name="range" /></div>
                                <div class="ion-danger mb-3"><input type="text" id="range_color_5" value="" name="range" /></div>
                            </div>
                        </div>
                        <div class="card card-shadow mb-4">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <small class="mb-3">Set up range with negative values</small>
                                <div class="mb-3"><input type="text" id="range_04" value="" name="range" /></div>
                                <small class="mb-3">Using step 250</small>
                                <div class="mb-3"><input type="text" id="range_05" value="" name="range" /></div>
                                <small class="mb-3">Set up range with fractional values, using fractional step</small>
                                <div><input type="text" id="range_06" value="" name="range" /></div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <small class="mb-3">Set up you own numbers</small>
                                <div class="mb-3"><input type="text" id="range_07" value="" name="range" /></div>
                                <small class="mb-3">Using any strings as your values</small>
                                <div class="mb-3"><input type="text" id="range_08" value="" name="range" /></div>
                                <small class="mb-3">One more example with strings</small>
                                <div><input type="text" id="range_09" value="" name="range" /></div>
                            </div>
                        </div>
                    ...
                    <div class=" col-md-6">
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <small class="mb-3">No prettify. Big numbers are ugly and unreadable</small>
                                <div class="mb-3"><input type="text" id="range_10" value="" name="range" /></div>
                                <small class="mb-3">Prettify enabled. Much better!</small>
                                <div class="mb-3"><input type="text" id="range_11" value="" name="range" /></div>
                                <small class="mb-3">Don't like space as separator? Use anything you like!</small>
                                <div class="mb-3"><input type="text" id="range_12" value="" name="range" /></div>
                                <small class="mb-3">You don't like default prettify function? Use your own!</small>
                                <div><input type="text" id="range_13" value="" name="range" /></div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <small class="mb-3">Using prefixes</small>
                                <div class="mb-3"><input type="text" id="range_14" value="" name="range" /></div>
                                <small class="mb-3">Using postfixes</small>
                                <div class="mb-3"><input type="text" id="range_15" value="" name="range" /></div>
                                <small class="mb-3">Whant to show that max number is not the biggest one?</small>
                                <div class="mb-3"><input type="text" id="range_16" value="" name="range" /></div>
                                <small class="mb-3">Taking care about how from and to values connect? Use decorate_both option:</small>
                                <div class="mb-3"><input type="text" id="range_17" value="" name="range" /></div>
                                <small class="mb-3">Remove double decoration</small>
                                <div class="mb-3"><input type="text" id="range_18" value="" name="range" /></div>
                                <small class="mb-3">Use your own separator symbol with values_separator option. Like →</small>
                                <div class="mb-3"><input type="text" id="range_19" value="" name="range" /></div>
                                <small class="mb-3">Or " to ":</small>
                                <div><input type="text" id="range_20" value="" name="range" /></div>
                            </div>
                        </div>
    ...
    <script src="assets/vendor/ion-slider-init.js"></script>
