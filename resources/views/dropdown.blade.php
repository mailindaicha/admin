    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="dropdown.html">Dropdowns</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Dropdown
                    <small>some dropdown examples</small>
                </h4>
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <p>Dropdown button</p>
                                <div class="dropdown mb-4">
                                    <button class="btn btn-outline-primary dropdown-toggle" type="button" id="dropdownMenuButton01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Dropdown button
                                    </button>
                                ...
                                <p>Dropdown link</p>
                                <div class="dropdown mb-4">
                                    <a class="btn btn-outline-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Dropdown link
                                    </a>
                                ...
                                <div class="btn-group mb-4">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-warning dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#">Action</a>
