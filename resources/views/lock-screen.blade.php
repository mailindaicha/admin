...
<body class="">
    ...
    <div class="container text-center">
        ...
        <form class="form-lock " action="index.html">

            <div class="lock-user text-center mb-4">
                <img class="rounded-circle" src="assets/img/user.png" alt="" width="80"/>
        ...
        <div class="change-user">
            <a href="#" class="default-color"><i class="fa fa-power-off pr-2"></i> Change User</a>
        </div>
