...
<head>
    ...
    <!--color picker style-->
    <link href="assets/vendor/colorpicker/css/bootstrap-colorpicker.css" rel="stylesheet">
...
<div class="app-body">
                    ...
                    <ul class="sub">
                        ...
                        <li class="sub-menu" >
                            ...
                            <ul class="sub">
                                ...
                                <li class="active"><a  href="color-picker.html">Color Picker</a></li>
                            </ul>
                        </li>
    ...
    <main class="main-content">
        ...
        <div class="page-title">
            <h4 class="mb-0"> Color Picker
                <small>some color pickers example</small>
            </h4>
                        ...
                        <div class="card-body">
                            <form class="picker-form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div id="cp2" class="input-group colorpicker-component mb-3" title="Using input value">
                                        ...
                                        <div id="cp3a" class="input-group colorpicker-component mb-3" data-color="#36a2f5"
                                        ...
                                        <div id="cp3b" class="input-group colorpicker-component mb-3" title="Using data-color attribute in the input">
                                            <input type="text" class="form-control input-lg" data-color="#34bfa3"/>
                                            <div class="input-group-append">
                                                <span class="input-group-addon btn btn-outline-secondary"><i></i></span>
                                            </div>
                                        </div>

                                        <div id="cp4" class="input-group colorpicker-component mb-3" title="Using color option">
                                            <input type="text" class="form-control input-lg"/>
                                            <div class="input-group-append">
                                                <span class="input-group-addon btn btn-outline-secondary"><i></i></span>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div id="cp5b" class="input-group colorpicker-component" title="Using format option">
                                            <input type="text" class="form-control input-lg" value="#FF518A"/>
                                            <div class="input-group-append">
                                                <span class="input-group-addon btn btn-outline-secondary"><i></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div id="cp6" class="input-group colorpicker-component" title="Using horizontal option">
                                            <input type="text" class="form-control input-lg" value="#36a2f5"/>
                                            <div class="input-group-append">
                                                <span class="input-group-addon btn btn-outline-secondary"><i></i></span>
                                            </div>
                                        </div>
...
<!--color picker-->
<script src="assets/vendor/colorpicker/js/bootstrap-colorpicker.min.js"></script>
<script src="assets/vendor/color-picker-init.js"></script>
