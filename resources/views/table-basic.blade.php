    ...
    <div class="app-body">
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Basic Table
                    <small>some example of basic table</small>
                </h4>
            ...
            <div class="widget">
                ...
                <div class="baseline baseline-border">
                    ...
                    <div class="baseline-list  baseline-border baseline-info">
                        <div class="baseline-info">
                            <div><a href="#" class="default-color"><strong>John Henry</strong></a> added your friend list now</div>
                            <span class="text-muted">10:00 PM Sat, 10 Jan 2018</span>
                        </div>
                    </div>
                </div>
