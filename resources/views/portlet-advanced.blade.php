    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="portlet-advanced.html">Portlets Advanced</a></li>
                        </ul>
                    </li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Portlets Advanced
                    <small>different portlets style</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Portlets Advanced</li>
                </ol>
            </div>
            <!--page title end-->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="card card-shadow lobicard-custom-icon mb-4">
                            ...
                            <div class="card-body">
                                <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem dolores nemis omnis fugats vitaes nemo minima rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets. Lid est laborum dolo rumes fugats untras.
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-today" role="tabpanel" aria-labelledby="pills-today-tab">
                                        <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem dolores nemis omnis fugats vitaes nemo minima rerum facilis dolores nemis omnis</p>
                                    </div>
                                    <div class="tab-pane fade" id="pills-week" role="tabpanel" aria-labelledby="pills-week-tab">
                                        <p>Etharums ser quidem dolores nemis omnis fugats vitaes nemo minima rerum facilis dolores nemis omnis</p>
                                    </div>
                                    <div class="tab-pane fade" id="pills-month" role="tabpanel" aria-labelledby="pills-month-tab">
                                        <p>Dolo rumes fugats untras. Etharums ser quidem dolores nemis omnis fugats vitaes nemo minima rerum facilis dolores nemis omnis</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card  border-danger  mb-4">
                            <div class="card-header bg-danger ">
                                <div class="card-title text-white">
                                    <i class="icon-compass pr-2"></i> Dropdown Portlet
                        ...
                        <div class="card  border-primary lobicard-custom-control lobi-light  mb-4">
                        ...
                        <div class="card card-shadow lobicard-custom-control lobi-light  mb-4">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem dolores nemis omnis fugat.</p>
                            </div>
                        </div>

                        <div class="card bg-info text-white border-0 mb-4">
                            <div class="card-header bg-info border-opacity">
                                <div class="card-title text-white ">
                                    Portlet with Action
                                    <div class="btn-group float-right task-list-action">
                                        <div class="dropdown ">
                        ...
                        <div class="card lobicard-custom-control lobi-light bg-success text-white border-0 mb-4">
                            <div class="card-header bg-success border-opacity">
                                <div class="card-title text-white ">
                                    Portlet with Action
                                </div>
                            </div>
                        ...
                        <div class="card bg-danger text-white border-0 mb-4">
                            <div class="card-header bg-danger border-opacity">
                                <div class="card-title text-white ">
                                    Portlet with Action
                                    <div class="btn-group btn-group-sm float-right" role="group" aria-label="Small button group">
                        ...
                        <div class="card lobicard-custom-control lobi-light bg-primary text-white border-0  mb-4">
                            <div class="card-header bg-primary border-opacity">
                                <div class="card-title text-white ">
                                    Portlet with Action
                                </div>
                            </div>
                        ...
                        <div class="card lobicard-custom-control lobi-light bg-warning text-white border-0 mb-4">
                            <div class="card-header bg-warning border-opacity">
                                <div class="card-title text-white ">
                                    Portlet with Action
                                </div>
                            </div>
