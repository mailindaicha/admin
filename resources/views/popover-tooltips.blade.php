    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="popover-tooltips.html">Popover & Tooltips</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Popovers & Tooltips
                    <small>popovers & tooltips examples</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Popovers & Tooltips</li>
                </ol>
            </div>
            <!--page title end-->
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <p class="fw-500">Four directions </p>
                                    <button type="button" class="btn btn-primary mb-2" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Popover on top
                                    </button>

                                    <button type="button" class="btn btn-secondary mb-2" data-container="body" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Popover on right
                                    </button>
                                    <br/>

                                    <button type="button" class="btn btn-success mb-2" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus
    sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Popover on bottom
                                    </button>

                                    <button type="button" class="btn btn-info mb-2" data-container="body" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                        Popover on left
                                    </button>
                                </div>

                                <div class=" ">
                                    <p class="fw-500">Dismiss on next click </p>
                                    <a tabindex="0" class="btn btn-lg btn-warning" role="button" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="And here's some amazing content. It's very engaging. Right?">Dismissible popover</a>
                                </div>
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <p class="fw-500">Default </p>
                                    <a href="#" data-toggle="tooltip" title="" data-original-title="Default tooltip">Default link</a>
                                    <button type="button" class="btn btn-info mb-2 ml-3" data-toggle="tooltip" title="" data-original-title="Default tooltip">
                                        Default Button
                                    </button>
                                </div>

                                <p class="fw-500">Four directions </p>
                                <button type="button" class="btn btn-info mb-2" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
                                    Tooltip on top
                                </button>
                                <button type="button" class="btn btn-success mb-2" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
                                    Tooltip on right
                                </button>
                                <br/>
                                <button type="button" class="btn btn-warning mb-2" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
                                    Tooltip on bottom
                                </button>
                                <button type="button" class="btn btn-danger mb-2" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
                                    Tooltip on left
                                </button>
                            </div>
                        </div>
