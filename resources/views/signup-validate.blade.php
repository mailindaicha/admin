    ...
    <div class="container">
        ...
        <form id="signinForm" method="get" class="form-signin rounded" action="index.html">
            ...
            <div class="form-group">
                <input type="text" class="form-control form-control-pill" id="username" name="username" placeholder="Username" />
            </div>
            ...
            <div class="form-group">
                <input type="password" class="form-control form-control-pill" id="confirm_password" name="confirm_password" placeholder="Confirm Password" />
            </div>
            ...
            <div class="form-group ">
                <button type="submit" class="btn btn-lg btn-pill btn-block btn-primary" name="signup" value="Sign up">Sign up</button>
            </div>
            <div class="mt-4">
                <span>
                    Already have an account ?
                </span>
                <a href="signin-validate.html" class="text-primary">Sign In</a>
            </div>
        </form>
