...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="form-multiple-select.html"> Multiple Select</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Multiple Select
                    <small>multiple select exmaple</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="default-color">Form</a></li>
                    <li class="breadcrumb-item active">Multiple Select</li>
                </ol>
            </div>
            <!--page title end-->
                            ...
                            <div class="card-body">
                                <form class="picker-form">
                                    <div class="form-group row mb-5">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Default</label>
                                    ...
                                    <div class="form-group row mb-5">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Grouped Option</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                    ...
                                    <div class="form-group row mb-5">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Searchable</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
    ...
    <script src="assets/vendor/multi-select/js/jquery.quicksearch.js"></script>
    <script src="assets/vendor/multiple-select-init.js"></script>
