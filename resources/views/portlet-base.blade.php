    ...
    <div class="app-body">
            ...
            <nav class="sidebar-menu">
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li  class="active"><a  href="portlet-base.html">Portlets Base</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Portlets Base
                    <small>different portlets style</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Portlets Base</li>
                </ol>
            </div>
            <!--page title end-->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card card-shadow mb-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <i class="icon-bell pr-2"></i> Heading Default
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card card-shadow btn-square mb-4">
                            <div class="card-header">
                                <div class="card-title">
                                    Square Box
                                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card card-shadow  mb-4">
                            ...
                            <div class="card-body">
                                <div class="portlets-scroll-wrap" style="height: 200px">
                                    <div class="portlets-scroll">
                                        <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem dolores nemis
                                            omnis fugats vitaes nemo minima rerum facilis dolores nemis omnis fugats
                                            vitaes nemo minima rerums unsers sadips amets. Lid est laborum dolo rumes
                                            fugats untras.
                                            Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo
                                            minimarerums unsers sadips amets. Lid est laborum dolo rumes fugats untras.
                                            ...
                                            amets. Lid est laborum dolo rumes fugats untras.
                                            Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo
                                            minimarerums unsers sadips amets. Lid est laborum dolo rumes fugats untras.
                                            Etharums ser quidem dolores nemis omnis fugats vitaes nemo minima rerum
                                            facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips
                                            ...
                                            amets. Lid est laborum dolo rumes fugats untras.
                                            Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo
                                            minimarerums unsers sadips amets.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
