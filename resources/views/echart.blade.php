...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-overlay right-sidebar-hidden">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a  href="echart.html">eCharts</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> eChart Page
                    <small>start your new page</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">eChart Page</li>
                </ol>
            </div>
            <!--page title end-->
                ...
                <div class="row">
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="b-line" style="height: 350px"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="bs-chart" style="height: 350px"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="nb-chart" style="height: 350px"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" col-sm-6">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <div id="np-Pie" style="height: 350px"></div>
                            </div>
                        </div>
                    </div>
                    <div class=" col-sm-6">
    ...
    <!--init echarts-->
    <script type="text/javascript" src="assets/vendor/echarts/init-echarts.js"></script>
