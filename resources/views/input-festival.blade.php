    ...
    <div class="app-body">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="sub-menu">
                                <a  href="#">Festival</a>
                                <ul class="sub">
                                    <li><a  href="/input-festival">Input Festival</a></li>
                                    <li><a  href="/edit-festival">Edit Festival</a></li>
                                </ul>
                            </li>
                            <li class="sub-menu">
                                <a  href="#">Program</a>
                                <ul class="sub">
                                    <li><a  href="/input-program">Input Program</a></li>
                                    <li><a  href="/edit-program">Edit Program</a></li>
                                </ul>
                            </li>
                            <li class="sub-menu">
                                <a  href="#">Kabar</a>
                                <ul class="sub">
                                    <li><a  href="/input-kabar">Input Kabar</a></li>
                                    <li><a  href="/edit-kabar">Edit Kabar</a></li>
                                </ul>
                            </li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Festival
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <!-- <li class="breadcrumb-item"><a href="#" class="default-color">Input</a></li> -->
                    <li class="breadcrumb-item active">Input Festival</li>
                </ol>
            </div>
            <!--page title end-->
            ...
            <div class="container-fluid">
                ...
                <!-- state start-->
                <form action="{{url('festival')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class=" col-sm-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <textarea id="summernote" name='content'>Hello..</textarea>
                            </div>
                        </div>
                    </div>
                </div>
