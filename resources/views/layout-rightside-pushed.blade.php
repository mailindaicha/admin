...
<head>
    ...
    <title>Layout Rightside Pushed</title>
...
<body class="app header-fixed left-sidebar-fixed right-sidebar-fixed right-sidebar-hidden">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li  class="active"><a  href="layout-rightside-pushed.html">Rightside Pushed</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Layout Rightside Pushed
                    <small>subtitle goes here</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Layout Rightside Pushed</li>
                </ol>
            </div>
            <!--page title end-->
