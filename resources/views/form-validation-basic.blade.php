    ...
    <div class="app-body">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li class="active"><a  href="form-validation-basic.html">Basic Validation</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Form Validation
                    <small>some form validation examples</small>
                </h4>
                ...
                <div class="row">
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group has-info">
                                        <label>Input Info</label>
                                        <input type="text" class="form-control has-input" placeholder=" ">
                                        <small class="form-text">We'll never share your email with anyone else.</small>
                                    </div>
                    ...
                    <div class=" col-md-6">
                        <div class="card card-shadow mb-4">
                            <div class="card-header">
                                <div class="card-title">
                                    Basic Horizontal validation
                                </div>
                            </div>
                            <form>
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Input Basic</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder=" ">
                                            <small class="form-text">We'll never share your email with anyone else.</small>
                                        </div>
                                    ...
                                    <div class="form-group row has-info">
                                        <label class="col-sm-3 col-form-label">Input Info</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder=" ">
                                            <small class="form-text">We'll never share your email with anyone else.</small>
                                        </div>
                                    ...
                                    <div class="form-group row has-success">
                                        <label class="col-sm-3 col-form-label">Input Success</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder=" ">
                                            <small class="form-text">We'll never share your email with anyone else.</small>
                                        </div>
                                    ...
                                    <div class="form-group row has-warning">
                                        <label class="col-sm-3 col-form-label">Input Warning</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder=" ">
                                            <small class="form-text">We'll never share your email with anyone else.</small>
                                        </div>
                                    ...
                                    <div class="form-group row has-danger">
                                        <label class="col-sm-3 col-form-label">Input Danger</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder=" ">
                                            <small class="form-text">We'll never share your email with anyone else.</small>
                                        </div>
