    ...
    <div class="app-body">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="sub-menu" >
                                ...
                                <ul class="sub">
                                    <li  class="active"><a  href="date-picker.html">Date Picker</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Date Picker
                    <small>some date pickers example</small>
                </h4>
                            ...
                            <div class="card-body">
                                <form class="picker-form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="input-group date dpMonths" data-date-viewmode="months" data-date-format="mm/yyyy" data-date="12-08-2017">
                                                ...
                                                <div class="input-group-append">
                                                    <button id="dp-mdo" class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar f14"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            ...
                                            <div class="input-group date" id='helper-datepicker'>
                                                <input type="text" class="form-control" value="05/25/2018">
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="input-group" data-date="05/25/2018" data-date-format="mm/dd/yyyy">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Inline Piker</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="" id="inline-datepicker"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <form class="picker-form">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Bottom Left</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="input-group date" id="datepicker-bottom-left" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="03-10-2018">
                                                <input type="text" class="form-control m-input" placeholder="03-10-2018" aria-label="Right Icon" aria-describedby="dp-left">
                                                <div class="input-group-append">
                                                    <button id="dp-left" class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar f14"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Bottom Right</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="input-group date" id="datepicker-bottom-right" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="03-10-2018">
                                                <input type="text" class="form-control m-input" placeholder="03-10-2018" aria-label="Right Icon" aria-describedby="dp-right">
                                                <div class="input-group-append">
                                                    <button id="dp-right" class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar f14"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Top Left</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="input-group date" id="datepicker-top-left" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="03-10-2018">
                                                <input type="text" class="form-control m-input" placeholder="03-10-2018" aria-label="Right Icon" aria-describedby="dp-top-left">
                                                <div class="input-group-append">
                                                    <button id="dp-top-left" class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar f14"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12 ">Top Right</label>
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                            <div class="input-group date" id="datepicker-top-right" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="03-10-2018">
                                                <input type="text" class="form-control m-input" placeholder="03-10-2018" aria-label="Right Icon" aria-describedby="dp-top-right">
                                                <div class="input-group-append">
                                                    <button id="dp-top-right" class="btn btn-outline-secondary" type="button"><i class="fa fa-calendar f14"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
