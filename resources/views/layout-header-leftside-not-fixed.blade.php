...
<head>
    ...
    <title>Layout Header & Leftside not Fixed</title>
...
<body class="app right-sidebar-hidden">
    ...
    <div class="app-body">
                ...
                <ul id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="a"><a  href="layout-header-leftside-not-fixed.html">Header & Leftside not Fixed</a></li>
        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <h4 class="mb-0"> Layout Header & Leftside not Fixed
                    <small>subtitle goes here</small>
                </h4>
                <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">Layout Header & Leftside not Fixed</li>
                </ol>
            </div>
            <!--page title end-->
